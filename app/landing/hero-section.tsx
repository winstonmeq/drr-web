          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter text-red-700 sm:text-5xl xl:text-6xl/none font-headline">
                Q-ALERT: Stay Alert, Stay safe
              </h1>
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                Our mission is to empower communities with real-time alert notifications 
                and easy incident reporting — anytime, anywhere, all in one app. 
                We help people stay informed, prepared, and connected during emergencies.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button asChild size="lg" className="bg-orange-400 hover:bg-accent/90 text-accent-foreground">
                <Link href="https://play.google.com/store/apps/details?id=com.alertify.app&hl=en">
