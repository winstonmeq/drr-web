...
const plans: PricingPlan[] = [
  {
    ...
    installationFee: 145000,
    userCount: 'Up to 350 Mobile devices',
    features: [
      { text: 'Standard Support', included: true },
      { text: 'Mobile Incident Management', included: true },
  ...
  },
  {
    ...
    subscriptionFee: 65000,
    installationFee: 190000,
    userCount: 'Up to 750 Mobile devices',
    features: [
      { text: 'Priority Support', included: true },
      { text: 'Advanced Incident Management', included: true },
